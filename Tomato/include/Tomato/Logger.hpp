...
#define TMT_CORE_CRITICAL(...) \
 ::tmt::logger::get_core_logger()->critical(__VA_ARGS__)

#define TMT_CLIENT_TRACE(...) \
 ::tmt::logger::get_client_logger()->trace(__VA_ARGS__)
#define TMT_CLIENT_DEBUG(...) \
 ::tmt::logger::get_client_logger()->debug(__VA_ARGS__)
#define TMT_CLIENT_INFO(...) \
 ::tmt::logger::get_client_logger()->info(__VA_ARGS__)
#define TMT_CLIENT_WARN(...) \
 ::tmt::logger::get_client_logger()->warn(__VA_ARGS__)
#define TMT_CLIENT_ERROR(...) \
 ::tmt::logger::get_client_logger()->error(__VA_ARGS__)
#define TMT_CLIENT_CRITICAL(...) \
 ::tmt::logger::get_client_logger()->critical(__VA_ARGS__)
